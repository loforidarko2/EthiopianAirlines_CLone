...
const DrawerContentScreen = () => {
  ...
  return (
    ...
    <View style={styles.LoginContainer}>
      <Image source={require('../assets/sheba.png')} style={styles.shebaimage}/>
      ...
      <TouchableOpacity onPress={handleTours}>
        ...
        <View style={styles.dutyContainer}>
        <Image source={require('../assets/shebadutyfree.png')} style={styles.shebaimage2}/>
        ...
        <View style={styles.dutyContainer}>
        <Image source={require('../assets/wingonly.jpg')} style={styles.shebaimage2}/>
