  ...
  return (
    <SafeAreaView style={styles.container}>
     ...
     <TouchableOpacity onPress={handleGoBack}>
        ...
        <Text style={styles.header}>Join ShebaMiles</Text>
      </View>
<ScrollView showsVerticalScrollIndicator={false}>
      <Text style={styles.sectionHeader}>Personal Details</Text>
      <View style={styles.groupBox}>
      <Text style={styles.instruction}>Please provide details as in passport.</Text>
        <View style={styles.fieldContainer}>
          ...
          <Text style={styles.label}>Last/Sur Name*</Text>
          <View style={styles.inputContainer}>
            <TextInput
              style={styles.input}
              value={lastName}
...
<Text style={styles.label}>Country code Phone Number</Text>
      ...
      <Button title="Register" onPress={handleFormSubmit} color="#FFCD00" />
      </ScrollView>
    </SafeAreaView>
  );
};
